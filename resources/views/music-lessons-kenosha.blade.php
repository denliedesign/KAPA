...
@section('description', 'Kenosha Piano Lessons, Kenosha Guitar Lessons, & More. ')
    ...
    <div class="bg-white">
        <div class="container pb-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-center">
                        <img src="/images/kenosha-piano-lessons.jpg" alt="guitar" class="img-fluid shadow rounded" style="max-height: 196.86px; object-fit: cover; object-position: 45% 60%; width: 100%;">
                    </div>
                ...
                <div class="col-sm">
                    <div class="d-flex justify-content-center">
                        <img src="/images/kenosha-voice-lessons.jpg" alt="guitar" class="img-fluid shadow rounded" style="max-height: 196.86px; object-fit: cover; object-position: 45% 60%; width: 100%;">
                    </div>
