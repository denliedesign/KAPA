                ...
                <div>
                    ...
                    <div class="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-4">
                        <div class="partner-div p-2">
                            <img src="images/logo-taking-shape.png" class="card-img-top" alt="...">
                        </div>
                        <div class="partner-div p-2">
                            <img src="images/logo-leap.png" class="card-img-top" alt="...">
                        </div>
                        <div class="partner-div p-2">
                            <img src="images/logo-ndeo.png" class="card-img-top" alt="...">
                        </div>
                        <div class="partner-div p-2">
                            <img src="images/logo-nhsda.png" class="card-img-top" alt="...">
                        </div>
                    </div>
                </div>
            </div>
